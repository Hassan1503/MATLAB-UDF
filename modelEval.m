classdef modelEval
    methods (Static)
        function [c_matrix,Result,RefereceResult]= getMatrix(actual,predict,Display)
            ...
            disp(c_matrix_table)
            [Result,RefereceResult]=modelEval.getValues(c_matrix,actual);
            ...
            if Display
                ...
                if n_class>2 
                    ...
                    TFPN=table(TruePositive,FalsePositive,FalseNegative,TrueNegative,...
                        'RowNames',row_name); disp(TFPN);
                    Param=struct2table(RefereceResult); disp(Param)
                else
                    disp('Two-Class Confution Matrix')
                    param={'','TruePositive','FalsePositive';...
                        'FalseNegative',c_matrix(1,1),c_matrix(1,2);...
                        'TrueNegative=TN',c_matrix(2,1),c_matrix(2,2)}; disp(param)
        ...
        function  [Result,ReferenceResult]= getValues(c_matrix,actual)
            %%
            %Finding
            %1.TP-True Positive
            %2.FP-False Positive
            ...
            % nnumber of classes
            support=ones(n_class,1);
            for i=1:n_class
                support(i,1)=sum(actual==i);
            end
            ...
            ReferenceResult.Sensitivity=Sensitivity';
            ...
            ReferenceResult.Support=support;
